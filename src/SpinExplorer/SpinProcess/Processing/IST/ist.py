...
def ist_3d(input_spec: NDArray,
    ...
    window_dim2 = np.ones(int(input_spec.shape[1]/2))
    ...
    def _reconstruct_until_l2(nus_fid: NDArray) -> NDArray:
        ...
        for iteration in range(1, max_iter + 1):
            nus_fid, threshold_signal_real, threshold_signal_imag, l2_norm, max_val = ist_iteration_3d(nus_fid, threshold, sampling_schedule, window_dim2, window_dim3)
